...
title: "Contribution report for Feb. 2026"
tags: ["report"]
description: "A contribution report for Feb. 2026, by @JohnTitor."
category: "report"
image: ""
draft: false
lang: "en"
...
(You can find my full contributions in February [here](https://github.com/JohnTitor?tab=overview&from=2026-02-01&to=2026-02-28))
...
Released [`dotenvor`](https://github.com/JohnTitor/dotenvor) which is a repleacement of `dotenv` and `dotenvy`.
...
- rust-lang/rust: Normalize capture place `ty`s to prevent ICE — https://github.com/rust-lang/rust/pull/152165
- actix/actix-web: fix: panic when `.to()/.service()` called after `.wrap()` on Route — https://github.com/actix/actix-web/pull/3944
- notify-rs/notify: feat: make Windows path style configurable — https://github.com/notify-rs/notify/pull/823
